...
export class DashboardComponent implements OnInit {
  ...
  constructor(private zone: NgZone, private apiService: CovidApiService) {
  }
  ...
  loadSorted() {
    this.apiService.getAll(this.sortType).subscribe((data: {}) => {
      this.countries = data;
      this.isLoadingCountries = false;
    });
  }
  ...
  loadRadar() {
    ...
    chart.cursor.fill = am4core.color('#5e72e4');
    chart.tooltip.label.fill = am4core.color('#5e72e4');
